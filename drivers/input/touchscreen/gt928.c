...
static const char *goodix_ts_name = "gt928-ts";
...
static void gtp_touch_down(struct goodix_ts_data* ts,s32 id,s32 x,s32 y,s32 w)
{
    ...
    input_report_abs(ts->input_dev, ABS_MT_POSITION_X, x * FORLINX_PANEL_WIDTH / ts->abs_x_max);
    input_report_abs(ts->input_dev, ABS_MT_POSITION_Y, y * FORLINX_PANEL_HEIGHT / ts->abs_y_max);
...
static void gtp_pen_down(s32 x, s32 y, s32 w, s32 id)
{
    ...
    input_report_abs(ts->pen_dev, ABS_MT_POSITION_X, x * FORLINX_PANEL_WIDTH / ts->abs_x_max);
    input_report_abs(ts->pen_dev, ABS_MT_POSITION_Y, y * FORLINX_PANEL_HEIGHT / ts->abs_y_max);
...
static s8 gtp_request_io_port(struct goodix_ts_data *ts)
{
    ...
    GTP_GPIO_AS_OUTPUT(gtp_int_gpio, 0);  
    GTP_GPIO_AS_OUTPUT(gtp_rst_gpio, 0);
...
static s8 gtp_request_input_dev(struct goodix_ts_data *ts)
{
    ...
    input_set_abs_params(ts->input_dev, ABS_MT_POSITION_X, 0, FORLINX_PANEL_WIDTH, 0, 0);
    input_set_abs_params(ts->input_dev, ABS_MT_POSITION_Y, 0, FORLINX_PANEL_HEIGHT, 0, 0);

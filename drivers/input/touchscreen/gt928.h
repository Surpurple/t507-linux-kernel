...
#define FORLINX_PANEL_WIDTH	1280
#define FORLINX_PANEL_HEIGHT	800
...
#define GTP_GPIO_AS_OUTPUT(pin, value)          do{\
...
#define GTP_I2C_NAME                "GT928-TS"
#define GT91XX_CONFIG_PROC_FILE     "gt928_config"
...
// Log define
#define GTP_INFO(fmt,arg...)           printk("<<-GTP-INFO-928->> "fmt"\n",##arg)
#define GTP_ERROR(fmt,arg...)          printk("<<-GTP-ERROR-928->> "fmt"\n",##arg)
#define GTP_DEBUG(fmt,arg...)          do{\
                                         if(GTP_DEBUG_ON)\
                                         printk("<<-GTP-DEBUG-928>> [%d]"fmt"\n",__LINE__, ##arg);\
                                       }while(0)

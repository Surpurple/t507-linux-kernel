...
#ifdef CONFIG_SUNXI_REGULATOR_DT
			if (regulator_set_voltage(priv->gmac_power[i],
					priv->gmac_power_vol[i],
					priv->gmac_power_vol[i]) != 0) {
